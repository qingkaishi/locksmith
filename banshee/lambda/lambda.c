...
l_type function (l_type arg1, l_type arg2)
{
  ...
  if ((ret =
       (struct function_ *) term_hash_find (term_sort_hash, s, 3)) == NULL)
    {
...
void l_type_con_match (gen_e arg1, gen_e arg2)
{
  switch (((gen_term) arg1)->type)
    {
    case BOOLEAN_:
      if (((gen_term) arg1)->type != ((gen_term) arg2)->type)
	...
	case FUNCTION_:
	  {
	    l_type_unify_ind (((struct function_ *) arg1)->f0,
			      ((struct function_ *) arg2)->f0);
	    l_type_unify_ind (((struct function_ *) arg1)->f1,
			      ((struct function_ *) arg2)->f1);
