...
*/
#ifndef STEENSGAARD_TERMS_NOTAG_H
#define STEENSGAARD_TERMS_NOTAG_H
#include "list.h"
#include <stdio.h>
#include "bool.h"
#include "linkage.h"
...
alabel_t alabel_t_cmp (const alabel_t e1, const alabel_t e2);

alabel_t alabel_t_eq (alabel_t e1, alabel_t e2);
...
void steensgaard_terms_notag_serialize (FILE * arg1, hash_table * arg2,
					unsigned long arg3);
hash_table *steensgaard_terms_notag_deserialize (FILE * arg1);
void steensgaard_terms_notag_region_serialize (FILE * arg1);
void steensgaard_terms_notag_region_deserialize (translation arg1,
						 FILE * arg2);
EXTERN_C_END
#endif
